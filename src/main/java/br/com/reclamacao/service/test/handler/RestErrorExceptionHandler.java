package br.com.reclamacao.service.test.handler;

import br.com.reclamacao.service.test.exception.NotFoundException;
import br.com.reclamacao.service.test.response.ErrorMessage;
...
public class RestErrorExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleGenericException(Exception ex) {
        ErrorMessage errorMessage = new ErrorMessage("Ocorreu um erro ao processar a operação de reclamações, tente novamente !");
